...
function Skills() {
  ...
  return (
    ...
    <section id="skills" className={styles.container} aria-label="Skills section">
      ...
      <ul className={styles.skillList} aria-label="Programming languages">
      ...
      <ul className={styles.skillList} aria-label="Web technologies">
      ...
      <ul className={styles.skillList} aria-label="Tools">
